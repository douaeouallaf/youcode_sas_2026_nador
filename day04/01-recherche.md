...
> push= ajoute un ou plusieur élément à la fin de tableau   unshift = ajout un ou plusieur éklément au début de tableau
...
> pop= élémin le dérniére élément dans le tableau shift= élémine lapremiére élement de
